    ...
    <div className="min-h-screen flex flex-col page-container">
      ...
      <main className="flex-1 main-spacing">
        <section className="content-center-xl">
          <div className="page-card page-card--accent-sky page-card--narrow" aria-labelledby="estudiante-datos-title">
            <div className="card-header card-header--gradient-sky">
              <div>
                <h1 id="estudiante-datos-title" className="card-title">Datos Personales (Estudiante)</h1>
            ...
            <form className="form-grid" onSubmit={(e) => e.preventDefault()}>
              ...
              <div className="actions-row md:col-span-2">
                ...
                <Link to="/estudiante/general"><Button variant="secondary" type="button">Cancelar</Button></Link>
              </div>
            </form>
          </div>
        </section>
